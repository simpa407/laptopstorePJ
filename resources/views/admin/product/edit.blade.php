...
<form id="productForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="display">Màn hình <span class="text-red">*</span></label>
                <input type="text" name="display" class="form-control" id="display" placeholder="Màn hình" required autocomplete="off" value="{{ $product->display }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="ram">RAM <span class="text-red">*</span></label>
                <input type="text" name="ram" class="form-control" id="ram" placeholder="RAM" required autocomplete="off" value="{{ $product->ram }}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" name="OS" required>
                  ...
                  <option value="Mac OS" {{ $product->OS == 'Mac OS' ? 'selected' : '' }}>Mac OS</option>
                  <option value="Windows" {{ $product->OS == 'Windows' ? 'selected' : '' }}>Windows</option>
                  <option value="Free Dos" {{ $product->OS == 'Free Dos' ? 'selected' : '' }}>Free Dos</option>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="storage">Ổ cứng <span class="text-red">*</span></label>
                <input type="text" name="storage" class="form-control" id="storage" placeholder="Ổ cứng" required autocomplete="off" value="{{ $product->storage }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="graphics">Card màn hình <span class="text-red">*</span></label>
                <input type="text" name="graphics" class="form-control" id="graphics" placeholder="Card màn hình" required autocomplete="off" value="{{ $product->graphics }}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="weight">Trọng lượng (kg) <span class="text-red">*</span></label>
                <input type="number" name="weight" class="form-control" id="weight" placeholder="Trọng lượng" required autocomplete="off" value="{{ $product->weight }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="dimensions">Kích thước <span class="text-red">*</span></label>
                <input type="text" name="dimensions" class="form-control" id="dimensions" placeholder="Kích thước" required autocomplete="off" value="{{ $product->dimensions }}">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
  ...
  <div class="box box-primary">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="old_product_details[{{ $product_detail->id }}][color]" class="form-control color" id="color_{{ $product_detail->id }}" placeholder="Màu sắc" required autocomplete="off" value="{{ $product_detail->color }}">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
    ...
    <div class="text-center box-footer">
      <button class="add btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Thêm Màu Sắc Sản Phẩm</button>
    </div>
  </div>
