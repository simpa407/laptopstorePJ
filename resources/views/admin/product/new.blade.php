          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="display" class="form-control" id="display" placeholder="Màn hình" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="ram">RAM <span class="text-red">*</span></label>
                <input type="text" name="ram" class="form-control" id="ram" placeholder="RAM " required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="storage" class="form-control" id="storage" placeholder="Ổ cứng " required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="graphics">Card màn hình <span class="text-red">*</span></label>
                <input type="text" name="graphics" class="form-control" id="graphics" placeholder="Card màn hình" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" min="1" name="weight" class="form-control" id="weight" placeholder="Trọng lượng" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="dimensions">Kích thước <span class="text-red">*</span></label>
                <input type="text" name="dimensions" class="form-control" id="dimensions" placeholder="Kích thước" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
