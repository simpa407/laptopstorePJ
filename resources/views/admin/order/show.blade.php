          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <img src="{{ asset('images/favicon.png') }}" alt="LaptopStore Logo" style="width: 100%; height: auto; object-fit: cover;">
              </div>
              <div style="color: #f33;">LaptopStore</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <br>
            <address>
              <b>Admin LaptopStore</b><br>
              Phone: (+84) 999 999 999<br>
              Email: LaptopStore@gmail.com<br>
