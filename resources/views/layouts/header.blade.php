  ...
  <div class="container">
    <div class="row display-flex">
      <div class="col-md-2 margin-auto trigger-menu">
        ...
        <div class="logo">
          <a class="logo-wrapper" href="{{ route('home_page') }}" title="{{ config('app.name') }}"><img src="{{ asset('images/laptoplogo.png') }}" alt="{{ config('app.name') }}"></a>
        </div>
      </div>
  ...
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: +84 999 999 999" title="(+84) 999 999 999">(+84) 999 999 999</a>
      </div>
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:laptopstore@gmail.com" title="laptopstore@gmail.com">laptopstore@gmail.com</a>
      </div>
    </div>
  </div>
</div>
