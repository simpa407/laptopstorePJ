            ...
            <div class="col-lg-3 col-md-4">
              <div class="infomation-detail">
                ...
                <div class="infomation-content">
                  <ul>
                    <li><label>Màn Hình:</label>{{ $data['product']->display ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>CPU:</label>{{ $data['product']->cpu ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>RAM:</label>{{ $data['product']->ram ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>Card màn hình:</label>{{ $data['product']->graphics? : 'Đang Cập Nhật...' }}</li>
                    <li><label>Ổ cứng:</label>{{ $data['product']->stoarage ? : 'Đang Cập Nhật...' }}</li>
                    <li><label>Kích thước:</label>{{ $data['product']->dimensions ?: 'Đang Cập Nhật...' }}</li>
                    <li><label>Kích thước:</label>{{ $data['product']->weight ?: 'Đang Cập Nhật...' }}</li>
