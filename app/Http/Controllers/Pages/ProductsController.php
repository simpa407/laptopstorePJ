...
class ProductsController extends Controller
{
  public function index(Request $request) {
    ...
    if($request->has('price') && $request->input('price') != null) {
      ...
      })->select('id','name', 'image',  'display', 'cpu', 'ram', 'storage', 'graphics', 'dimensions', 'weight', 'OS', 'pin', 'rate')->orderBy('min_sale_price', $request->input('price'));
    } else {
      $query_products->select('id','name', 'image',  'display', 'cpu', 'ram', 'storage', 'graphics', 'dimensions', 'weight', 'OS', 'pin', 'rate')->latest();
    }
